...
function getUserPseudo() {
  const pseudo = prompt(`Bravo ! Tu as réussi en ${tryCount} essai. Donne moi ton pseudo pour faire partie du highScore !`);
  if (pseudo === null) {
    return null;
  }
  if (pseudo === "") {
...
sendNumber.onclick = function () {
  ...
  if (gameStart) {
    if (randomNumber === newNumber) {
      ...
      setTimeout(function () { answer.innerHTML = ""; }, 3500)
    }
...
const color = ["blue", "red", "yellow", "rosybrown", "royalblue", "hotpink", "lawngreen", "white", "aqua", "purple", "olivedrab", "orange", "yellowgreen", "maroon", "pink",];
const textHighScore = ["MeilLeur Sco_re", "FeiLLeur Score", "Meill3ur 5cor3", "M3illeur Sc0re", "MeilleUR Score", "SCORE MeiLLeur", "m33lleur ScoRE", "MeiooeuR sc0re", "M$éll$eur ScOrE", "M3IkLEUR Score", "Meilleur SCORE", "meilleur Sc0RE", "Meill__r Sc_re", "M!ill!ur Score", "M!il__ur Sc!re", ];
